...
### Example: Growth Without Bound {#exm:no-limit2}
...
caption: "The function for Example \\@ref(ex:limitonept)."
```
...
caption: "The function for Example \\@ref(ex:onesidea)"
```
...
caption: "The function for Example \\@ref(ex:onesideb)"
```
...
caption: "The function for Example \\@ref(ex:onesidec)"
```
...
caption: "The function for Example \\@ref(ex:onesided)"
```
