...
### Limit of Infinity, $\infty$ {#def:limit_of_infinity}
...
### One-Sided Limits of Infinity {#def:onesided_limit_of_infinity}
...
-   The term [left- (or, right-) hand limit of $f$ at c is negative
    ...
    \@ref(def:limitofinfinity).

\

### Evaluating limits involving infinity {#ex_inflim1}


Find $\displaystyle \lim_{x\rightarrow 1}\frac1{(x-1)^2}$ as shown in
Figure \@ref(fig:inflim1).

[In Example \@ref(exnolimit2) of Section \@ref(sec:limitintro), by
...
### Evaluating limits involving infinity {#ex_inflim2}
...
### Vertical Asymptote {#def:vertical_asymptote}
...
### Finding vertical asymptotes {#ex_vertasy1}
...
used the Squeeze Theorem in Section \@ref(sec:limitanalytically) to prove
this.\
...
### Limits at Infinity and Horizontal Asymptotes {#def:limit_at_infinity}
...
with Definition \@ref(def:limitofinfinity).\

### Approximating horizontal asymptotes {#ex_hzasy1}
...
### Limits of Rational Functions at Infinity {#thm:lim_rational_fn_at_infty}
...
1.  If $n=m$, then
    $\displaystyle\lim_{x\rightarrow\infty} f(x) = \lim_{x\rightarrow-\infty} f(x) = \frac{a_n}{b_m}$.

2.  If $n<m$, then
    $\displaystyle\lim_{x\rightarrow\infty} f(x) = \lim_{x\rightarrow-\infty} f(x) = 0$.

3.  If $n>m$, then $\displaystyle\lim_{x\rightarrow\infty} f(x)$ and
    $\displaystyle\lim_{x\rightarrow-\infty} f(x)$ are both infinite.
...
### Finding a limit of a rational function {#ex_hzasy2}
...
Before using Theorem \@ref(thm:limrationalfnatinfty), let’s use the
...
We can also use Theorem \@ref(thm:limrationalfnatinfty) directly;
in this case $n=m$ so the limit is the ratio of the leading coefficients
of the numerator and denominator, i.e., 1/1 = 1.

\

### Finding limits of rational functions {#ex_hzasy3}


Use Theorem \@ref(thm:limrationalfnatinfty) to evaluate each of the
following limits.
