...
$$f(x) = \begin{cases}{cl} x^2-2x+3 & x\leq 1 \\ x & x>1 \end{cases}.$$
...
## Epsilon-Delta Definition of a Limit {#sec:limit_def}
...
One thing to consider in Examples \[exonesidea\] – \[exonesided\] is
...
\
\
In Examples \[exonesidea\] – \[exonesided\] we were asked to find
both $\displaystyle \lim_{x\to 1}f(x)$ and $f(1)$. Consider the following table:

                              $\displaystyle \lim_{x\to 1}f(x)$     $f(1)$
  -------------------------- ------------------------- -------------
   Example \@ref(exonesidea)       does not exist             1
   Example \@ref(exonesideb)              1              not defined
   Example \@ref(exonesidec)              0                   1
   Example \@ref(exonesided)              1                   1

Only in Example \@ref(exonesided) do both the function and the limit
