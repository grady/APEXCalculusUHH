...
```{tikz chainrulegears, fig.cap="A series of gears to demonstrate the Chain Rule. Note how $\\frac{dy}{dx} = \\frac{dy}{du}\\cdot\\frac{du}{dx}$", echo=FALSE, dev="svg", fig.width=NULL, cache=TRUE}
