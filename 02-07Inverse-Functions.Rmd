...
```{geogebra, label="inverse3"}

caption: >
   A right triangle defined by $y=\sin ^{-1}(x/1)$ with the length
   of the third leg found using the Pythagorean Theorem.
...
trigonometric functions. In Figure \@ref(fig:domain-trig) we show the
...
their domains (as listed in Figure \@ref(fig:domain-trig)) and their
