...
We follow the steps outlined in Key Idea \@ref(def:extrema). We first
...
\@ref(def:extrema) as it is continuous on $[-4,2]$ (one should check to
...
We again use Key Idea \@ref(def:extrema). Evaluating $f$ at the
