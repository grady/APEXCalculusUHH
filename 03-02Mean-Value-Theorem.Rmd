...
(ex). Comparing average and instantaneous rates of change

------------------------------------------------------------------------

Consider functions
$$f_1(x)=\frac{1}{x^2}\quad \text{and} \quad f_2(x) = |x|$$ with $a=-1$
and $b=1$ as shown in Figure \@ref(fig:mvt1)(a) and (b), respectively.
Both functions have a value of 1 at $a$ and $b$. Therefore the slope of
...
::: {#fig:mvt1 .tab}
**Table 1**. caption: A graph of $f_1(x) = 1/x^2$ and $f_2(x) = |x|$ in
Example \@ref(exm:mvt1).
:::
...
Note that the reasons that the functions in Example \@ref(exm:mvt1) fail
