...
$f^{\prime}'$, which is the second derivative of $f$. When
$f^{\prime}'>0$, $f^{\prime}$ is increasing. When $f^{\prime}'<0$,
f\^ is decreasing. $f^{\prime}$ has relative maxima and minima where
$f^{\prime}'=0$ or is undefined.
