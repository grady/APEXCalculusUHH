...
caption: >
    A sketch of the enclosure in Example \@ref(exm:opt1).
...
caption: >
    A sketch of the enclosure in Example \@ref(exm:opt2ex).
...
```{geogebra, label="opt3b"}

caption: >
    Running a power line from the power station to an offshore facility with minimal cost in Example \@ref(exm:opt3).

```

------------------------------------------------------------------------

We will follow the strategy of Key Idea \@ref(idea:optimization)
...
```{geogebra, label="opt3c"}

caption: >
    Labeling unknown distances in Example \@ref(exm:opt3).
