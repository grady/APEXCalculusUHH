...
> **Note:** Example \@ref(exm:rr3) is both interesting and impractical.
...
$$\tan \theta = \frac{x}{10}.\label{eq:rr4}$$ As the car is moving at
...
implicit differentiation: $$\begin{aligned}
        ...
        \frac{d\theta}{dt} &= \frac{\cos^2\theta}{10}\frac{dx}{dt}\label{eq:rr4b}\end{aligned}$$
...
caption: >
    Tracking a speeding car (at left) with a rotating camera.
