...
Although these two integral problems look very similiar, their answers are quite different.
In the first integral the variable of integration is $s$ as indicated by the differential $ds$.
...
$F(x)=\frac{1}{n+1} s^{n+1}$ is one such function, provided that $n\neq -1$. Therefore, the 
